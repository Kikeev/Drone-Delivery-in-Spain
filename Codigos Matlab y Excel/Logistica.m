...
%%
i=14; k=2;
[tiv_d(i,k),ti_d(i,k),tv_d(i,k),t_ofi_d(i,k),t_ci_d(i,k),t_di_d(i,k),t_paqi_d(i,k)]
...
t_paqi=( h_d/V_paq )/60; % Se le añaden 15 segundos del pre-check para que todo esté OK antes de salir (al principio del todo)
