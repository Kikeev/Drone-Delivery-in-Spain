...
for k=1:3 % Variacion del precio por pedido
    p_p(k,:) = linspace(15,30,nc); % Valor del pedido
    ...
    for i=1:nc
        ...
        while c_compp(k,i)>comision
            ...
            c_com(k,i) = p_t(k,i) - p_ge(k,i)/1.21; % Coste asumido por comercio
...
C_comercio = IVA*C_be(:,1)./(Ciclos_dia'*365) - IVA*C_eg*linspace(1,1,length(P_Pedido_be)); % Coste que percibe el comercio
